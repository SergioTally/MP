...
public class Fiscalia {
	...
	private int fs_id;
	@Column(name="fs_nombre", length=50, nullable=false)
	private String fs_nombre;
	@Column(name="fs_direccion", length=200, nullable=false)
	private String fs_direccion;
	@Column(name="fs_gps", length=20, nullable=false)
	private String fs_gps;
	@Column(name="fs_numero", length=13, nullable=false)
	...
	public String getFs_gps() {
		return fs_gps;
	}
	public void setFs_gps(String fs_gps) {
		this.fs_gps = fs_gps;
	}
